...
func TestGeneratedActionDispatchErrors(t *testing.T) {
	...
	_, err = c.InvokeAction(ctx, connector.ActionCall{Provider: "googleads", Method: "Missing"})
	...
	mu.Unlock()
	_, err = c.InvokeAction(ctx, connector.ActionCall{Provider: "googleads", Method: first.name})
