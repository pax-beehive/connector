...
func TestGeneratedActionDispatchErrors(t *testing.T) {
	...
	_, err = c.InvokeAction(ctx, connector.ActionCall{Provider: "openaiads", Method: "Missing"})
	...
	mu.Unlock()
	_, err = c.InvokeAction(ctx, connector.ActionCall{Provider: "openaiads", Method: first.name})
