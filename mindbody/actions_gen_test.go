...
func TestGeneratedActionDispatchErrors(t *testing.T) {
	...
	_, err = c.InvokeAction(ctx, connector.ActionCall{Provider: "mindbody", Method: "Missing"})
	...
	mu.Unlock()
	_, err = c.InvokeAction(ctx, connector.ActionCall{Provider: "mindbody", Method: first.name})
