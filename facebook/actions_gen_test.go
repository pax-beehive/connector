...
func TestGeneratedActionDispatchErrors(t *testing.T) {
	...
	_, err = c.InvokeAction(ctx, connector.ActionCall{Provider: "facebook", Method: "Missing"})
	...
	mu.Unlock()
	_, err = c.InvokeAction(ctx, connector.ActionCall{Provider: "facebook", Method: first.name})
